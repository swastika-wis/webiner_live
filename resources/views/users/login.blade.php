    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5" >
          <div class="card-body p-0" style="border: 2px solid black">
                ...
                <div class="p-5">
                  ...
                  <form class="user needs-validation" novalidate action="{{route('user-validate')}}" method="POST" >
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" aria-describedby="email" required placeholder="Enter Email Address" name="phone">
                    </div>
