            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                          ...
                          <div class="p-5">
                            ...
                            <form class="user needs-validation" novalidate action="/abregister" method="POST">
                              <div class="form-group">
                                
                                  <input type="text" class="form-control form-control-user" name="FirstName" id="FirstName" placeholder="Full Name" required>
                              ...
                              <div class="form-group">
                              Do you have a financial advisor with Aditya Birla
                              <div class="form-check">
                                  <input class="form-check-input" type="radio" name="financialAdvisor" id="financialAdvisor" value="Yes">
                                  <label class="form-check-label" for="inlineRadio1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="financialAdvisor" id="financialAdvisor" value="No">
                                  <label class="form-check-label" for="inlineRadio2">No</label>
                                </div>
                                  <!--input type="checkbox" class="form-control-checkbox" id="financialAdvisor" name="financialAdvisor" >Do you have a financial advisor with Aditya Birla //-->
                              </div>

                            

                              <div class="form-group" >
                                <input type="text" class="form-control form-control-user" name="financialAdisorname"  id="financialAdisorname" placeholder="Your Financial Advisor Name" >
                                
                                
                              </div>
                              <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="financialAdisorarn"  id="financialAdisorarn" placeholder="Your Financial Advisor ARN No." >
                              </div>
